...
std::string Loader::Impl::getGameVersion() {
    if (m_gdVersion.empty()) {
        std::ifstream version_file("/data/data/com.geode.launcherlite/files/game_version.txt");
        if (!version_file) {
        ...
        switch (version_code) {
            ...
            case 41: m_gdVersion = "2.2074"; break; // rob incremented version code even though its practically 2.2074
