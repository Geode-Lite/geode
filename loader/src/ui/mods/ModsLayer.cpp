...
bool ModsLayer::init() {
    ...
    for (auto item : std::initializer_list<std::tuple<const char*, const char*, ModListSource*, const char*, bool>> {
        ...
        { "globe.png"_spr, "Download", ServerModListSource::get(ServerModListType::Lite), "lite-download-button", true },
        { "fullButton.png"_spr, "Full Game", ServerModListSource::get(ServerModListType::Download), "download-button", false },
